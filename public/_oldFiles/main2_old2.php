...
<head>
    ...
    <!-- Tailwind CSS CDN con configuración para colores cálidos -->
    <script>
      tailwind.config = {
        theme: {
          extend: {
            colors: {
              primary: '#EF4444',   // rojo tomate
              secondary: '#F97316', // naranja vibrante
              accent: '#10B981',    // verde fresco
              background: '#FFF7ED', // fondo crema claro
...
<body class="bg-background font-sans text-textPrimary min-h-screen flex flex-col">
    ...
    <header class="bg-primary text-white shadow-lg">
        <div class="container mx-auto px-6 py-5 flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div class="mt-4 md:mt-0 text-sm text-white/90">
                ...
                <a href="logout.php" class="ml-4 underline hover:text-secondary">(Salir)</a>
            </div>
        </div>
    </header>
    ...
    <main class="container mx-auto px-6 py-12 flex-grow space-y-20">
        ...
        <section id="servicios" class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <article class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition cursor-default">
                <h3 class="text-2xl font-semibold mb-3 text-primary">Menú Digital</h3>
                <p class="text-textSecondary">Consulta el menú de cada puesto con imágenes, descripciones y precios actualizados al instante.</p>
            </article>
            <article class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition cursor-default">
                <h3 class="text-2xl font-semibold mb-3 text-primary">Mapa Interactivo</h3>
                <p class="text-textSecondary">Ubica fácilmente cada food truck en el evento para que no pierdas tiempo buscando tu comida favorita.</p>
            </article>
            <article class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition cursor-default">
                <h3 class="text-2xl font-semibold mb-3 text-primary">Opiniones y Favoritos</h3>
                <p class="text-textSecondary">Lee reseñas de otros clientes y guarda tus puestos favoritos para reservar rápido la próxima vez.</p>
            </article>
        </section>

        <section id="contacto" class="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
            <h2 class="text-3xl font-heading text-primary mb-6 text-center">Contacto</h2>
            <p class="text-center text-textSecondary mb-4">¿Tienes dudas o quieres más información? Escríbenos:</p>
