...
const bookingApp = {
    ...
    renderStep3() {
        ...
        container.innerHTML = `
            ...
            <div class="bg-gray-50 rounded-lg p-6 max-w-2xl mx-auto">
                ...
                <div class="confirmation-buttons">
                    <button onclick="window.print()" class="bg-primary text-white hover:bg-red-700 transition flex items-center">
                    ...
                    <button onclick="location.href='reservas.php'" class="bg-gray-600 text-white hover:bg-gray-700 transition flex items-center">
        ...
        // Configurar evento para nueva reserva
        document.getElementById('btn-new-reservation').addEventListener('click', () => {
            this.currentStep = 1;
            this.cart = [];
            this.renderStep1();
